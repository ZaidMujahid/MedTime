...
const Footer = () => {
  return (
    ...
    >
      <div className="flex flex-row space-x-8 pb-2 pt-4">
        <div className="flex flex-col space-x-4 mx-auto items-center mb-2 ">
        <div>
        <span>
        <GiMedicines className="inline text-5xl mx-2 text-sky-600"/>
        </span>
        <h1 className="font-bold text-3xl cursor-pointer bg-clip-text text-gray-900 inline">Medtime</h1>
        </div>
